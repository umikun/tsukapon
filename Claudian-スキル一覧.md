...
### 1. [[.claude/commands/re-daily.md|/re-daily]] — note記事リライト＋サムネ文言＋X記事版＋Xスレッド＋本日アクションプラン一気通貫生成 ⭐ UPDATED 2026-05-01（Step 4 に「太字（`**...**`）の使い方ルール」を新設：太字は20字以内のキーワード限定、Nつ目: は最大15字、25字超太字が5個以上で書き直しの自己チェック義務化）

...
- **MCP (Model Context Protocol)**: Claude等のAIエージェントが外部ツール/データソースを呼ぶ標準。RTKもMCPサーバー化フォークが登場済み — 関連: [[2026-04-26-create-agent-tui-openrouter]] の文脈とつながる
...
- **既存vault内の文脈**: Claude Code関連の調査ノート [[2026-04-24-claude-code-plugin-marketplace]] [[2026-04-23-claude-obsidian-llm-wiki]] と並べて、「Claude Code 周辺ツールの俯瞰マップ」を作ると価値が出る

...
- **既存vault内の文脈**: Claude Code関連の調査ノート [[調査/2026-04-24-claude-code-plugin-marketplace.md]] [[2026-04-23-claude-obsidian-llm-wiki]] と並べて、「Claude Code 周辺ツールの俯瞰マップ」を作ると価値が出る

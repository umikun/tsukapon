...
- **Plugin Marketplace**: skill配布の経済圏化が進行中。詳細は [[2026-04-24-claude-code-plugin-marketplace]]
- **コンテキスト圧縮プロキシ**: Skill/MCPで肥大化する出力を叩く方向性。RTK と context-mode が代表格（[[調査/2026-04-26-rtk-token-killer-cli-proxy.md]] / [[2026-04-26-cash-while-you-sleep-10-repos]]）
